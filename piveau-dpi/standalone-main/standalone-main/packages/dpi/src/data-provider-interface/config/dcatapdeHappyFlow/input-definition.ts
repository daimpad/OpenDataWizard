...
const dcatapProperties: InputDefinition = {
  datasets: {
    reviewandpublishpage: {
      $formkit: "reviewAndPublishPage",
      name: "reviewAndPublishPage",
    },
    distributionsimplepage: {
      $formkit: "dcat:distribution",
      name: "dcat:distribution",
    },
    descriptionV3: {
      $formkit: "dct:description",
      name: "dct:description",
    },
    geocodingURI: {
      $formkit: "dcatde:politicalGeocodingURI",
      name: "dcatde:politicalGeocodingURI",
    },
    temporalCoverage: {
      $formkit: "dcat:temporalResolution",
      name: "dcat:temporalResolution",
    },
    publisherV3: {
      $formkit: "dct:publisher",
      name: "dct:publisher",
    },
    contactpage: {
      $formkit: "dcat:contactPoint",
      name: "dcat:contactPoint",
    },
    coveringpage: {
      $formkit: "coveringPage",
      name: "coveringPage",
    },
    distLicense: {
      $formkit: "dct:license",
    ...
    updatedate: {
      $formkit: "dct:modified",
      name: "dct:modified",
    },
    basicinfospage: {
      $formkit: "basicInfosPage",
      name: "basicInfosPage",
    },
    discoverabilitypage: {
      $formkit: "discoverabilityPage",
      name: "discoverabilityPage",
    },
    landingpage: {
      $formkit: "happyFlowLandingPage",
      name: "happyFlowLandingPage",
    },
    hvd: {
      $formkit: "hvdPage",
      name: "hvdPage",
