...
class ODW_Quality {
    ...
    public static function init(): void {
        ...
        add_action( 'save_post_odw_dataset', [ self::class, 'recalculate_on_save' ], 30 );
        ...
        add_filter( 'odw_dataset_jsonld', [ self::class, 'append_to_jsonld' ], 10, 2 );
    }
    ...
    public static function get_indicators(): array {
        return [
            ...
            [ 'key' => 'title',        'label' => __( 'Titel (dct:title)',                    'open-data-wizard' ), 'points' => 10, 'required' => true ],
            [ 'key' => 'description',  'label' => __( 'Beschreibung (dct:description)',       'open-data-wizard' ), 'points' => 10, 'required' => true ],
            [ 'key' => 'publisher',    'label' => __( 'Herausgeber (dct:publisher)',           'open-data-wizard' ), 'points' => 10, 'required' => true ],
            [ 'key' => 'license',      'label' => __( 'Lizenz (dct:license)',                 'open-data-wizard' ), 'points' => 10, 'required' => true ],
            [ 'key' => 'distribution', 'label' => __( 'Distribution mit URL (dcat:accessURL)', 'open-data-wizard' ), 'points' => 15, 'required' => true ],

            // Empfohlene Felder (DCAT-AP 3.0 recommended) — 40 Punkte
            [ 'key' => 'language',     'label' => __( 'Sprache (dct:language)',               'open-data-wizard' ), 'points' => 10, 'required' => false ],
            [ 'key' => 'keywords',     'label' => __( 'Schlagworte (dcat:keyword)',           'open-data-wizard' ), 'points' => 10, 'required' => false ],
            [ 'key' => 'theme',        'label' => __( 'Thema (dcat:theme)',                   'open-data-wizard' ), 'points' => 10, 'required' => false ],
            [ 'key' => 'issued',       'label' => __( 'Veröffentlichungsdatum (dct:issued)',  'open-data-wizard' ), 'points' => 10, 'required' => false ],

            // Optionale Angaben — 5 Punkte
            [ 'key' => 'dist_format',  'label' => __( 'Format der Distribution (dct:format)', 'open-data-wizard' ), 'points' =>  5, 'required' => false ],
        ];
        // Summe: 55 + 40 + 5 = 100
    }
    ...
    private static function empty_result(): array {
        return [ 'score' => 0, 'level' => '', 'indicators' => [], 'calculated_at' => '' ];
    }
}
