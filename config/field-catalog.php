...
return array(
	...
	array(
		...
		'q_human'     => 'Welchen Themen ist dieser Datensatz zugeordnet?',
		...
		'desc_human'  => 'Wählen Sie ein oder mehrere Themengebiete, zu denen die Daten passen — ähnlich einer Schublade, in die der Datensatz einsortiert wird. Das hilft anderen, Ihre Daten über Themenfilter zu finden. Beispiel: Umwelt, Bildung, Gesundheit, Wirtschaft, Kultur.',
	),
	array(
		'key'         => 'keywords',
		...
		'desc_human'  => 'Tragen Sie einzelne Schlagwörter ein, unter denen man Ihre Daten suchen würde — jedes Wort in eine eigene Zeile. Sie ergänzen das Thema und machen die Daten leichter auffindbar. Beispiel: erst „Umwelt", darunter „Wasser", darunter „Luftverschmutzung". Trennen Sie die Schlagwörter nicht mit Komma.',
	),
	array(
		'key'         => 'cessda_topic',
	...
	array(
		...
		'desc_dcat'   => 'Nur relevant, wenn im Lizenzfeld „Sonstige" gewählt wurde: Hier wird die `dct:license`-URI einer nicht in der Standardliste enthaltenen Lizenz eingetragen. Das Auto-Suggest bietet zusätzlich die URIs des DCAT-AP.de-Lizenzregisters (`http://dcat-ap.de/def/licenses/…`) an. Multiplizität 0..1 je Distribution — es ist dieselbe Eigenschaft wie oben.',
	...
	array(
		...
		'desc_dcat'   => 'Teil des `dcat:contactPoint` (Range `vcard:Kind`): `vcard:fn` benennt die Kontaktstelle oder -person für Rückfragen zum Datensatz. Multiplizität 0..1 je Kontaktpunkt; ein Datensatz kann mehrere Kontaktpunkte tragen (0..n). Name, E-Mail und URL bilden zusammen einen Kontaktpunkt.',
	...
	array(
		...
		'desc_human'  => 'Geben Sie an, ob die Daten für alle offen (öffentlich), nur eingeschränkt oder gar nicht öffentlich zugänglich sind. Für offene Daten ist das in der Regel „öffentlich". Beispiel: Öffentlich. „Öffentlich" ist bereits vorausgewählt — ändern Sie die Angabe nur, wenn der Zugriff eingeschränkt oder gar nicht öffentlich ist.',
	),
	array(
		'key'         => 'is_hvd',
		...
		'desc_dcat'   => 'Kennzeichen, ob der Datensatz ein High-Value-Dataset im Sinne der EU-Durchführungsverordnung 2023/138 ist. Ist es gesetzt, wird `dcatap:applicableLegislation` (Verweis auf die Verordnung) ausgegeben und das Feld HVD-Kategorie relevant. Multiplizität 0..1.',
	...
	array(
		...
		'desc_human'  => 'Falls Ihr Datensatz eine feste Kennnummer aus Ihrem eigenen System hat, tragen Sie sie hier ein. So bleibt der Datensatz eindeutig identifizierbar. Beispiel: DS-2026-00042. Neben einer internen Nummer können Sie hier auch eine dauerhafte, extern vergebene Kennung wie einen DOI eintragen.',
	),
	array(
		'key'         => 'type',
		'meta_key'    => '_odw_type',
		...
		'desc_human'  => 'Geben Sie an, um welche Art von Datensatz es sich grundsätzlich handelt. Das hilft bei der groben Einordnung. Beispiel: Statistische Erhebung, Geodaten. Einzutragen ist die vollständige Web-Adresse des passenden Eintrags aus der EU-Liste der Datensatz-Typen, nicht die Bezeichnung als Text.',
	),
	array(
		'key'         => 'creator_name',
	...
	array(
		...
		'desc_human'  => 'Bei Geodaten: Geben Sie an, wie fein die Daten räumlich aufgelöst sind — der kleinste unterscheidbare Abstand in Metern. Ein kleiner Wert bedeutet detailliertere Daten. Beispiel: 10 (Raster von 10 Metern). Tragen Sie dabei nur die Zahl ein, ohne die Einheit dahinterzuschreiben.',
	),
	array(
	...
	array(
		...
		'desc_human'  => 'Falls Ihre Daten einem bestimmten Standard oder Schema folgen, nennen Sie ihn hier. So können Systeme die Daten korrekt interpretieren. Beispiel: INSPIRE, XÖV oder ein fachliches Datenschema. Einzutragen ist die Web-Adresse, unter der der Standard beschrieben ist.',
	),
	array(
		'key'         => 'provenance',
