...
**➡️ [docs/TECHNICAL-SPEC.md](docs/TECHNICAL-SPEC.md)**
...
**In Planung (v2.2+):** — Details siehe [Technische Spezifikationen § 7](docs/TECHNICAL-SPEC.md#7-umsetzungsplanung-phasiert)
